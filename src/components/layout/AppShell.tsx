...
export default function AppShell() {
  ...
  const isZooPage = location.pathname.startsWith('/profile/zoo');
  const hideNav = isSharePage || isDetailPage || isCheckInPage || isSettingsPage || isWeeklyPage || isFoodMapPage || isPersonalityPage || isZooPage;
